...
class TutorialPipeline(object):
    def __init__(self):
        ...
        self.page = etree.Element('html')
        self.xmldoc = etree.ElementTree(self.page)
        etree.SubElement(self.page, 'head')
        self.bodyElt = etree.SubElement(self.page, 'body')
        self.all_contents = {}
    ...
    def process_item(self, item, spider):
        ...
        title = etree.SubElement(self.bodyElt, 'h1', id=item['id'])
        title.text = item['title']
        contents = etree.SubElement(self.bodyElt, 'div')
